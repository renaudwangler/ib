...
.PARAMETER restart
Redemarre l'ordinateur à la fin du script (inactif par defaut)
.EXAMPLE
...
Chemin (obligatoire) complet du certificat .rdp � t�l�charger
.EXAMPLE
import-ib1TrustedCertificate "http://mars.ib-formation.fr/marsca.cer"
Importera le certificat mentionn� dans le magasin des certificat de confiance de l'utilisateur actuel.
#>
[CmdletBinding(

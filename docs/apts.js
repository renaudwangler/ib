...
function aptsLoad() {
  ...
  document.body.innerHTML=h1+'<a href=https://github.com/renaudwangler/ib/edit/master/docs/'+pageName+'.html class="gitbutton pill">\
  <span class="class="icon  icon--github">\
...
028,5.302-3.935,5.302-7.362C15.76,3.906,12.285,0.431,7.999,0.431z"/></svg>\
</span>Edition/Suggestion</a>\

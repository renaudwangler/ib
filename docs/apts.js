...
function aptsLoad() {
  ...
  document.body.innerHTML='<a href="index.html" title="Retour à la liste." id="back">Retour</a><h1>'+ibCourse+' - Accompagnement Pédagogique et Technique de stage</h1>'+document.body.innerHTML+'<div id="master1"></div><div id="master0"></div><div id="outro"></div>';

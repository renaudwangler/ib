...
>**Nota :** La réalisation de cette procédure suppose que vous avez correctement réalisé la [Procédure 1](#proc%C3%A9dure-1-cr%C3%A9er-quelques-resources-g%C3%A9n%C3%A9riques-dans-azure) précédente.  
...
>**Nota 2 :** La réalisation de cette procédure suppose que vous avez correctement réalisé la [Procédure 1](#proc%C3%A9dure-1-cr%C3%A9er-quelques-resources-g%C3%A9n%C3%A9riques-dans-azure) précédente.  
...
>**Nota 2:** Si vous ne voulez/pouvez pas vous connecter en RDP sur la machine virtuelle d'administration, vous pouvez vous y connecter en créant un *Bastion* en suivant les étapes **1** à **6** de la [procédure 3](#proc%C3%A9dure-3--permettre-lacc%C3%A8s-bastion-%C3%A0-une-vm).  

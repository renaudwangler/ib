...
In this lab, you will get started with Azure Key Vault to create a vault in Azure, to store and manage secrets in Azure. First you will use Azure PowerShell. Then you will store a password as a secret.

...
if ($env:ibCourse -eq $null) {
  ...
  if ($env:ibCourse -ne $null) {
    ...
    Write-EventLog -LogName ib1 -Source powerShellib1 -Message "Import du module : Inscription de l'identité du stage '$course' dans la variable système 'ibCourse' suite ) découverte de VM." -EntryType Information -EventId 3}}

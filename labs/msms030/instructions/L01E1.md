...
*Note *: A free M365 free trial subscription must be obtained in order to carry out this course.  
...
1. In the **Tell us about yourself** enter the mandatory informations ( choose a name for your trail company, select a *50-249 people* company size and select your credit card country) and click **Next**
...
1. In the **Organization information** window that appears, enter the following information:
	- Name: Replace the name you choosed in the first task with **Adatum Corporation** 
